<?php
/**
 * $Header: /cvsroot/xoops/modules/xplayhistory/classes/Log/display.php,v 1.1 2004/12/25 20:04:34 garbelini Exp $
 *
...
class Log_display extends Log
{
    ...
    public function log($message, $priority = null)
    {
        ...
        echo $this->_error_prepend .
             ...
             nl2br(htmlspecialchars($message, ENT_QUOTES | ENT_HTML5)) .
