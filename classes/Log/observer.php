<?php
/**
 * $Header: /cvsroot/xoops/modules/xplayhistory/classes/Log/observer.php,v 1.1 2004/12/25 20:04:34 garbelini Exp $
...
class Log_observer
{
     ...
     *
     * @param int   $priority   The highest priority at which to receive
    ...
    public function factory($type, $priority = PEAR_LOG_INFO, $conf = [])
    {
        ...
        if (file_exists(__DIR__ . '/observer_' . $type . '.php')) {
        ...
        if (!$newstyle) {
            trigger_error(
                'Using old-style Log_observer conventions',
                E_USER_WARNING
            );
        }
