<?php
// $Id: daemon.php,v 1.1 2004/12/25 20:04:34 garbelini Exp $
...
class Log_daemon extends Log
{
     ...
     * @param null   $priority (optional) The priority of the message.  Valid
    ...
    public function log($message, $priority = null)
    {
        ...
        $facility_level = (int)$this->_name + (int)$this->_toSyslog($priority);
        ...
        if (mb_strlen($message) > $this->_maxsize) {
            $message = mb_substr($message, 0, ($this->_maxsize) - 10) . ' [...]';
        }
    ...
    public function _toSyslog($priority)
    {
        ...
        if (!is_int($priority) || !in_array($priority, $priorities, true)) {
            return LOG_INFO;
        }
