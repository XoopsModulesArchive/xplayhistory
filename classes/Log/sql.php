<?php
/**
 * $Header: /cvsroot/xoops/modules/xplayhistory/classes/Log/sql.php,v 1.1 2004/12/25 20:04:34 garbelini Exp $
...
class Log_sql extends Log
{
    ...
    {
        $this->_ident = mb_substr($ident, 0, $this->_identLimit);
    }
    ...
    public function log($message, $priority = null)
    {
        ...
        $q = sprintf(
            'insert into %s (id, logtime, ident, priority, message)' .
                     'values(%d, CURRENT_TIMESTAMP, %s, %d, %s)',
            $this->_table,
            $id,
            $this->_db->quote($this->_ident),
            $priority,
